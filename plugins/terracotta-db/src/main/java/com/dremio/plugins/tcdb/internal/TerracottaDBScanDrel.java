...
public class TerracottaDBScanDrel extends ScanRelBase implements Rel {

  public TerracottaDBScanDrel(RelOptCluster cluster, RelTraitSet traitSet, RelOptTable table,
  ...
  public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new TerracottaDBScanDrel(getCluster(), traitSet, table, pluginId, tableMetadata, projectedColumns, observedRowcountAdjustment);
  }

  @Override
  public ScanRelBase cloneWithProject(List<SchemaPath> projection) {
    return new TerracottaDBScanDrel(getCluster(), traitSet, table, pluginId, tableMetadata, projection, observedRowcountAdjustment);
  }
